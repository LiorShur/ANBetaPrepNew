...
@keyframes gradientShift {
  0%, 100% { background: linear-gradient(135deg, #667eea 0%, #764ba2 50%, #4a7c59 100%); }
  33% { background: linear-gradient(135deg, #4a7c59 0%, #667eea 50%, #764ba2 100%); }
  66% { background: linear-gradient(135deg, #764ba2 0%, #4a7c59 50%, #667eea 100%); }
}
